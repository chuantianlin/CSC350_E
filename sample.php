...
<body>
  <div class="intro">
    ...
    <img src="bmcc4.png" height="250" width="250" alt="">
  </div>
              ...
              for ($z=1; $z <= $col; $z++)
               {
                ...
                while($The_Date[$index]==$DATE[$time_index])
                {
                  ...
                  echo "<strong><p>SECTION:</strong><br>".$section[$index]."</br>" ;
                  echo"<strong><p>TIME:</strong><br>".$starttime[$index]."-".$Endtime[$index]."</br>";
...
<address class="address">
  Developed by Chuantian Lin and William Zhicay <br><br>
  Email us:<br>
  <a href="mailto:llcttt@gmail.com ">llcttt@gmail.com </a> <br>
  <a href="williamzhicay32@gmail.com">williamzhicay32@gmail.coms</a>
</address>
 </body>
